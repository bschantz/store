...
export declare type HmrCallback<T> = (ctx: StateContext<T>, state: Partial<T>) => void;
export declare type BootstrapModuleFn<T = any> = () => Promise<NgModuleRef<T>>;
 ...
 */
export declare type WebpackModule = WebpackHotModule | any;
export {};
